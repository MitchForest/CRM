    ...
    private function createLeadActivities(array $leadIds, array $userIds): void
    {
        ...
        foreach ($qualifiedLeads as $leadId) {
            ...
            DB::table('calls')->insert([
                ...
                'date_end' => (clone $callDate)->modify('+15 minutes')->format('Y-m-d H:i:s'),
                'duration' => 15,
                'parent_type' => 'Leads',
                'parent_id' => $leadId,
                ...
                switch ($activityType) {
                    case 'call':
                        DB::table('calls')->insert([
                            ...
                            'date_end' => (clone $currentDate)->modify('+30 minutes')->format('Y-m-d H:i:s'),
                            'duration' => 30,
                    ...
                    case 'meeting':
                        ...
                        DB::table('meetings')->insert([
                            ...
                            'deleted' => 0,
                            'status' => 'Held',
                            'type' => $this->getMeetingType($opp->sales_stage),
        ...
        foreach ($activeContacts as $contactId) {
            ...
            if ($this->randomProbability(60)) {
                ...
                DB::table('calls')->insert([
                    ...
                    'direction' => 'Outbound',
                    'date_start' => $callDate->format('Y-m-d H:i:s'),
                    'date_end' => (clone $callDate)->modify('+20 minutes')->format('Y-m-d H:i:s'),
                    'duration' => 20,
                    'parent_type' => 'Contacts',
                    'parent_id' => $contactId,
